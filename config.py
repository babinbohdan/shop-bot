...
class Settings(BaseSettings):
    ...
    WELCOME_BANNER_URL: str = ""    # URL фото/банеру для нових користувачів (залишіть порожнім щоб без фото)
    WELCOME_PROMO_CODE: str = "WELCOME10"   # промокод для нових користувачів
    WELCOME_PROMO_DISCOUNT: int = 10        # знижка у відсотках
